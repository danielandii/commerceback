							...
							<div class="list-icons">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a href="{{ route('transaksi.edit',$transaksi->id)}}" class="dropdown-item"><i class="icon-pencil7"></i> Edit</a>
										<a href="{{ route('transaksi.detail_transaksi',$transaksi->id)}}" class="dropdown-item"><i class="icon-clipboard3"></i> Detail</a>
							            <a class="dropdown-item delbutton" data-toggle="modal" data-target="#modal_theme_danger" data-uri="{{ route('transaksi.destroy', $transaksi->id)}}"><i class="icon-x"></i> Delete</a>
									</div>
								</div>
							</div>
				        </td>
