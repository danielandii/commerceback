...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i>Gambar Ulasan</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
					<fieldset class="mb-3">
						<legend class="text-uppercase font-size-sm font-weight-bold">Gambar ulasan {{@$ulasan->produk->nama}} oleh {{@$ulasan->user->nama}}</legend>

						<div class="row">
							@foreach($ulasan->gambar_ulasan as $gambar) 
