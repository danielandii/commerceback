	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i>Ubah Kategori</h4>
				...
				<form class="form-validate-jquery" action="{{ route('kategori.update', $kategori->id)}}" method="post" enctype="multipart/form-data">
					...
					<fieldset class="mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" name="nama" class="form-control border-teal border-1 @error('nama') is-invalid @enderror" placeholder="Nama" required autofocus autocomplete="off" value="{{ ( old('nama') ) ? old('nama') : $kategori->nama }}">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								...
								<a href="{{ $kategori->url_logo ? asset($kategori->url_logo) : asset('global_assets/images/user-default.png') }}" data-popup="lightbox">
									<img src="{{ $kategori->url_logo ? asset($kategori->url_logo) : asset('global_assets/images/user-default.png') }}" class="img-preview rounded-round mr-2" width="50%" style="object-fit:contain">
								</a>
								</div>
								<input type="file" name="url_logo" class="form-control border-teal border-1 @error('url_logo') is-invalid @enderror" placeholder="Logo"  value="{{ ( old('url_logo') ) ? old('url_logo') : $kategori->url_logo }}">
							</div>
						</div>
