...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i>Edit Toko</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				{{-- <form class="form-validate-jquery" action="{{ route('toko.update', $toko->id)}}" method="post"> --}}
					@method('PATCH')
					@csrf
					<fieldset class="mb-3">
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="file" name="logo" class="form-control border-teal border-1 @error('logo') is-invalid @enderror" placeholder="Logo" required autocomplete="off" value="{{ old('logo') }}">
							</div>
						</div>
